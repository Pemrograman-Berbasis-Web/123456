...
Silahkan pilih dan gunakan _alat bantu_ diatas sesuai kebutuhan dan selera. `Namun sekali-lagi kamu harus **_bersabar_**, jangan terburu-buru langsung loncat menggunakan framework...`Materi JavaScript ini ingin meng-`encourage` kamu untuk perlahan mempelajari JS dari dasar.
